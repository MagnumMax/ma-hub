...
| **pin tag** | критичный прод, не хотим сюрпризов | в `AGENTS.md`: `Pin: v1.0.0`; `MA_HUB_REF=v1.0.0 ma-hub-ensure-latest` |

Проекты **не хранят копию** стандартов целиком — только канон-файлы и режим (pin в `AGENTS.md`). Иначе копии устаревают.
