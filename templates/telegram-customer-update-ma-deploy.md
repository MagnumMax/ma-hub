...
1. Phase 7 прошла: production READY + обязательные пути OK (или явный fallback «нет браузера»). Провал пути → **не** заходить в 7.5. Прод **не** откатывать из‑за Telegram.
