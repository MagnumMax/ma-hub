...
## Карта для внешних ИИ (`llms.txt`)
Режимы с GEO: вставить **полный черновик** (или diff). Сборка: [llms-txt.md](llms-txt.md).  
Спросить: обновить живой источник (`public/llms.txt` **или** уже существующий роут/генератор)? **да** (рекомендую) / нет. Не плодить второй файл.
