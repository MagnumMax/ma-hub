...
|-------|----------------|------------|
| `review-bugbot` | `~/.cursor/skills-cursor/review-bugbot/` | `/MA-deploy` Phase 1A: только если **волна** меняет **поведение**; один проход; **не** `/review`. Не из `/MA-signoff` |
| `review-security` | `~/.cursor/skills-cursor/review-security/` | `/MA-deploy` Phase 1A: если **волна** про **вход / роли / платежи / PII / секреты**; один проход; **не** `/review`. Не из `/MA-signoff` |
